import { o as objectType, g as dateType, h as arrayType, i as stringType, A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, j as escape, k as renderUniqueStylesheet, l as renderScriptElement, n as createHeadAndContent, r as renderComponent } from './astro/server_DzFHpl4b.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CsAXVZf3.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_B1-kVhoJ.mjs');
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_BW1rqGZ4.mjs');
...
export { DEFAULT_HASH_PROPS as D, getEntry as a, getCollection as g, isRemotePath as i };

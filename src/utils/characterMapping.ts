...
export const CHARACTER_ALIAS_MAP: Record<string, string> = {
  ...
  PHILIP: "royalty/prince-philip",
  PHILLIP: "royalty/prince-philip",
  "PRINCE PHILIP": "royalty/prince-philip",
  "PRINCE PHILLIP": "royalty/prince-philip",
  ...
  MARGARET: "royalty/princess-margaret",
  MARGARETTE: "royalty/princess-margaret",
  "PRINCESS MARGARET": "royalty/princess-margaret",
  "PRINCESS MARGARETTE": "royalty/princess-margaret",
...
export const CHARACTER_DISPLAY_NAMES: Record<string, string> = {
  ...
  'MARGARETTE': 'Princess Margaret',
  'PRINCESS MARGARET': 'Princess Margaret',
  'PRINCESS MARGARETTE': 'Princess Margaret',
